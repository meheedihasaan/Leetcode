 ...
 * @author Acer
 */
public class Day8_LowestCommonAncestorOfABinarySearchTree_235 {
    ...
    public static void main(String[] args) {
        Day8_LowestCommonAncestorOfABinarySearchTree_235 t = new Day8_LowestCommonAncestorOfABinarySearchTree_235();
        t.createTree();
